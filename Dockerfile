...
RUN comfy model download --url "https://civitai.red/api/download/models/2786084?fileId=2672243?token=00d4f9d5da710441e457df098bcb0386" --relative-path "models/checkpoints" --filename "Jankuv7.Safetensors"
RUN comfy model download --url "https://civitai.com/api/download/models/2485296?type=Model&format=SafeTensor&size=full&fp=bf16&token=00d4f9d5da710441e457df098bcb0386" --set-civitai-api-token "00d4f9d5da710441e457df098bcb0386" --relative-path "models/checkpoints" --filename "NetaYumeLuminaV4.0.safetensors"
RUN comfy model download --url "https://civitai.red/api/download/models/3065644?fileId=2944325?token=00d4f9d5da710441e457df098bcb0386" --relative-path "models/checkpoints" --filename "AnimaYumev10.safetensors"
