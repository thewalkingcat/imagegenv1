...
RUN comfy model download --url "https://civitai.red/api/download/models/3273711?fileId=3157659&token=00d4f9d5da710441e457df098bcb0386" --relative-path "models/diffusion_models" --filename "waianimaturbo.safetensors"
