...
RUN comfy model download --url "https://civitai.com/api/download/models/3064584?fileId=2943406" --set-civitai-api-token "00d4f9d5da710441e457df098bcb0386" --relative-path "models/checkpoints" --filename "krea2.safetensors"
